...
{
    public partial class tsku_attributeRepository : BaseRepository, Itsku_attributeRepository
    {
        #region BasicMethod
        /// <summary>
        /// 获取一个实体
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public CriticalMass.TagNode.Model.tsku_attribute GetModel(long id)
        {
            IDbConnection conn = base.GetConnection();
            string sqlCommandText = @"SELECT `id`,`sku_id`,`attr_name_id`,`attr_val_id`,`createBy`,`createTime`,`modifyBy`,`modifyTime` from tsku_attribute where ID=" + id + " limit 1";
            return conn.Query<CriticalMass.TagNode.Model.tsku_attribute>(sqlCommandText).SingleOrDefault();
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public CriticalMass.TagNode.Model.tsku_attribute GetModel(string where)
        {
            IDbConnection conn = base.GetConnection();
            string sqlCommandText = @"select `id`,`sku_id`,`attr_name_id`,`attr_val_id`,`createBy`,`createTime`,`modifyBy`,`modifyTime` from  tsku_attribute where " + where + " limit 1";
            return conn.Query<CriticalMass.TagNode.Model.tsku_attribute>(sqlCommandText).SingleOrDefault();
        }
        ...
        {
            IDbConnection conn = base.GetConnection();
            page.TotalCount = conn.Query<int>("select count(0) from tsku_attribute where " + where).First();
            string sql = @"SELECT `id`,`sku_id`,`attr_name_id`,`attr_val_id`,`createBy`,`createTime`,`modifyBy`,`modifyTime` FROM tsku_attribute WHERE {0} {1} limit {2},{3}";
            var list = conn.Query<CriticalMass.TagNode.Model.tsku_attribute>(string.Format(sql, where, page.Sort, page.StartItemIndex, page.PageSize)).ToList();
            page.List = list;
            return page;
        }
        ...
        /// <param name="where">条件</param>
        /// <returns></returns>
        public List<CriticalMass.TagNode.Model.tsku_attribute> GetList(string where)
        {
            IDbConnection conn = base.GetConnection();
            string sql = @"SELECT `id`,`sku_id`,`attr_name_id`,`attr_val_id`,`createBy`,`createTime`,`modifyBy`,`modifyTime` FROM tsku_attribute WHERE {0} ";
            var list = conn.Query<CriticalMass.TagNode.Model.tsku_attribute>(string.Format(sql, where)).ToList();
            return list;
        }
        ...
        {
            IDbConnection conn = base.GetConnection();
            string sql = @"SELECT ID FROM tsku_attribute WHERE {0} limit 1";
        ...
        {
            IDbConnection conn = base.GetConnection();
            string sqlCommandText = @"delete from tsku_attribute where id=@id";
        ...
        /// <param name="id">id</param>
        /// <returns></returns>
        public bool Del(string where, CriticalMass.TagNode.Model.tsku_attribute parameter)
        {
        ...
        {
            IDbConnection conn = base.GetConnection();
            string sqlCommandText = @"delete from tsku_attribute where id in (" + ids + ")";
        ...
        /// <returns></returns>
        public bool Update(CriticalMass.TagNode.Model.tsku_attribute model, IDbTransaction trn)
        {
            IDbConnection conn = trn.Connection;
        ...
        /// <param name="model">模型</param>
        /// <returns></returns>
        public bool Update(string field, CriticalMass.TagNode.Model.tsku_attribute model)
        {
            IDbConnection conn = base.GetConnection();
            if (model.id <= 0)
            {
        ...
        public int Update(string field, string where)
        {
            ...
            string sqlCommandText = @"update tsku_attribute set " + field + " where " + where;
        ...
        /// <returns></returns>
        public int Insert(CriticalMass.TagNode.Model.tsku_attribute model)
        {
            IDbConnection conn = base.GetConnection();
